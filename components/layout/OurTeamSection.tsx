      ...
      <div className="container">
        <div className="grid lg:grid-cols-2 md:gap-14 gap-7 items-stretch">
          <div className="flex flex-col gap-5 h-full">
            <div className="flex flex-col gap-6 md:items-start items-center justify-center">
              <span
                ...
                className="bg-secondary/20 text-secondary px-6 py-2 rounded-full xl-para font-medium w-fit"
              >
                Our Team
              </span>
              ...
              <h2
                ...
                data-aos-duration="1000"
                data-aos-delay="200"
                className="heading font-semibold leading-tight md:text-start text-center"
              >
              ...
              <p
                ...
                data-aos-duration="1000"
                data-aos-delay="400"
                className="text-gray-600 leading-relaxed md:text-start text-center"
              >
          ...
          <div
            ...
            data-aos-duration="1000"
            data-aos-delay="200"
            className="relative bg-white rounded-3xl border border-gray-200 p-10 h-full flex flex-col"
          >
            ...
            <h3
              ...
              data-aos-duration="1000"
              data-aos-delay="200"
              className="heading font-semibold mb-4 md:text-start text-center"
            >
              Our Commitment
            </h3>
            ...
            <p
              ...
              data-aos-duration="1000"
              data-aos-delay="400"
              className="text-gray-600 mb-8 xl-para md:text-start text-center"
            >
