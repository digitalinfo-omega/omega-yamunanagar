      ...
      <div className="relative flex flex-col md:gap-8 gap-6">
        {services.map((service, i) => (
          ...
          >
            ...
            {/* icon */}
            <div className="absolute top-3 sm:top-5 left-6 sm:left-10 animate-iconFloat">
              <Image
                src={service.gif}
                alt={service.title}
                width={30}
            ...
            {/* arrow */}
            <button className="absolute bottom-2.5 sm:bottom-6 right-6 sm:right-13">
              <ArrowRight
                className="md:text-50 text-10 group-hover:translate-x-1 duration-100 transition-transform"
                color="#299fb0"
              />
            </button>
